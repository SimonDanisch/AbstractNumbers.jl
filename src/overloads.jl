...
function Base.:cmp(arg1::AbstractNumber, arg2::AbstractNumber, arg3::AbstractNumber)
    tmp = Base.:cmp(number(arg1), number(arg2), number(arg3))
    like(arg1, tmp)
end
...
function SpecialFunctions.:lgamma(arg1::AbstractNumber)
    tmp = SpecialFunctions.:lgamma(number(arg1))
    like(arg1, tmp)
end

function SpecialFunctions.:gamma(arg1::AbstractNumber)
    tmp = SpecialFunctions.:gamma(number(arg1))
    like(arg1, tmp)
end

function SpecialFunctions.:airy(arg1::AbstractNumber)
    tmp = SpecialFunctions.:airy(number(arg1))
    like(arg1, tmp)
end

function SpecialFunctions.:airy(arg1::AbstractNumber, arg2::AbstractNumber)
    tmp = SpecialFunctions.:airy(number(arg1), number(arg2))
    like(arg1, tmp)
end

function SpecialFunctions.:airy(a::AbstractNumber, b::Number)
    tmp = SpecialFunctions.:airy(number(a), b)
    like(a, tmp)
end

function SpecialFunctions.:airy(a::Number, b::AbstractNumber)
    tmp = SpecialFunctions.:airy(a, number(b))
    like(b, tmp)
end

function SpecialFunctions.:airyprime(arg1::AbstractNumber)
    tmp = SpecialFunctions.:airyprime(number(arg1))
    like(arg1, tmp)
end

function SpecialFunctions.:beta(arg1::AbstractNumber, arg2::AbstractNumber)
    tmp = SpecialFunctions.:beta(number(arg1), number(arg2))
    like(arg1, tmp)
end

function SpecialFunctions.:beta(a::AbstractNumber, b::Number)
    tmp = SpecialFunctions.:beta(number(a), b)
    like(a, tmp)
end

function SpecialFunctions.:beta(a::Number, b::AbstractNumber)
    tmp = SpecialFunctions.:beta(a, number(b))
    like(b, tmp)
end

function SpecialFunctions.:lbeta(arg1::AbstractNumber, arg2::AbstractNumber)
    tmp = SpecialFunctions.:lbeta(number(arg1), number(arg2))
    like(arg1, tmp)
end

function SpecialFunctions.:lbeta(a::AbstractNumber, b::Number)
    tmp = SpecialFunctions.:lbeta(number(a), b)
    like(a, tmp)
end

function SpecialFunctions.:lbeta(a::Number, b::AbstractNumber)
    tmp = SpecialFunctions.:lbeta(a, number(b))
    like(b, tmp)
end
